...
router.post('/products', JwtUtil.checkToken, async function (req, res) {
  ...
  const product = { name: name, price: price, image: image, cdate: now, category: category, description: description};
...
router.put('/products/:id', JwtUtil.checkToken, async function (req, res) {
  ...
  const category = await CategoryDAO.selectByID(cid);
  const product = { _id: _id, name: name, price: price, image: image, cdate: now, category: category, description };
